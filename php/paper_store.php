...
$sql = "UPDATE `paper` SET `paper_name` = '{$paper_name}', `source` = '{$source}', `publish` = '{$publish}', `seminar_loc` = '{$seminar_loc}', `seminar_time` = '{$seminar_time}', `page` = '{$page}', `vol` = '{$vol}', `no` = '{$no}', `keyword1` = '{$keyword1}', `keyword2` = '{$keyword2}', `keyword3` = '{$keyword3}', `keyword4` = '{$keyword4}', `keyword5` = '{$keyword5}', `teacher` = '{$teacher}', `report_time` = '{$report_time}', `update_time` = '{$time}' WHERE `paper_id` = '{$paper_id}'";
